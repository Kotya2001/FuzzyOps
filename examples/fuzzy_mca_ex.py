...
Задача:
Выбор лучшего смартфона среди нескольких моделей

Покупатель выбирает между тремя моделями смартфонов, учитывая стоимость (дешевле — лучше) и качество (лучше качество — 
лучше смартфон).

Все смартфоны сравниваются попарно по стоимости и качеству камеры, используя нечеткие оценки 
(например, «немного лучше», «намного лучше» и т. д.). Метод попарных сравнений позволяет ранжировать смартфоны, 
выявляя лучшую модель, учитывая все критерии.
...
alternatives = ["Смартфон 1", "Смартфон 2", "Смартфон 3"]
