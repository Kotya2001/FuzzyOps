...
class TestFuzzyNN(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        classification_data = pd.read_csv(os.path.join(project_root, "fuzzy_nn", "tests", "data", "Iris.csv"))
        reg_data = pd.read_csv(os.path.join(project_root, "fuzzy_nn", "tests", "data", "sales.csv"))
