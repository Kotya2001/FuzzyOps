...
def fuzzy_and_mm(mf1: Tuple, mf2: Tuple) -> Tuple:
    return (torch.minimum, mf1, mf2)

def fuzzy_or_mm(mf1: Tuple, mf2: Tuple) -> Tuple:
    return (torch.maximum, mf1, mf2)

def fuzzy_and_prob(mf1: Tuple, mf2: Tuple) -> Tuple:
    return (torch.mul, mf1, mf2)

def fuzzy_or_prob(mf1: Tuple, mf2: Tuple) -> Tuple:
