...
class TestFuzzyNN(unittest.TestCase):
    """
    Testing fuzzy neural networks algorithm 2
    """
    def setUp(self):
        self.project_root = os.path.abspath(os.path.join(os.path.dirname(__file__), '..'))

        self.data_path = os.path.join(self.project_root, "tests", "ex.csv")
    ...
    def testNeuralNetPrediction(self):
        """
        Testing a fuzzy neural network (XOR problem)
        """
    ...
    def testNeuralNetCPUSpeed(self):
        """
        Testing fuzzy neural networks on a GPU with big data
        """
    ...
    def testNeuralNetGPUSpeed(self):
        """
        Testing fuzzy neural networks on GPUs with big data
        """
